...
class DQN_Base_model(torch.nn.Module):
    ...
    def __init__(self, state_space, action_space, num_actions):
        """Defining DQN base model
        """
...
class DQN_MLP_model(DQN_Base_model):
    ...
    def __init__(self, state_space, action_space, num_actions):
        ...
        """
        # initialize all parameters
        super(DQN_MLP_model, self).__init__(state_space, action_space,
                                            num_actions)
        # architecture
...
class DQN_CNN_model(DQN_Base_model):
    ...
    def __init__(self,
        ...
        """
        # initialize all parameters
        super(DQN_CNN_model, self).__init__(state_space, action_space,
                                            num_actions)
