...
def process(args):
    ...
    if args.format == "adjlist":
        ...
        raise Exception("Unknown file format: '%s'.  Valid formats: 'adjlist', 'edgelist', 'mat'" %
                        args.format)
...
def main():
    ...
    parser.add_argument('--matfile-variable-name',
                        default='network',
                        help='variable name of adjacency matrix inside a .mat file.')

    parser.add_argument(
        '--max-memory-data-size',
        default=1000000000,
        type=int,
    ...
    #                   help='Treat graph as undirected.')                     help='Treat graph as undirected.')

    parser.add_argument('--vertex-freq-degree',
                        default=False,
                        action='store_true',
