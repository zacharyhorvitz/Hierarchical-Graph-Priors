...
class DQN_MALMO_CNN_model(torch.nn.Module):
    ...
    def build_model(self):
        ...
        self.node_2_game_char = self.build_gcn(self.mode,
                                               self.hier,
                                               self.use_layers,
...
#                                   self.mode != 'cnn')
        ...
        if self.mode == 'embed_bl_converged_init':
            ...
            self.embeds.weight = torch.nn.Parameter(
                torch.FloatTensor(np.load("attribute_vector_neg_8.npy")).to(self.device))
    ...
    def build_gcn(self, mode, hier, use_layers, reverse_direction):
        ...
        if mode in ["skyline", "skyline_atten"] and not hier:
            ...
            edges = [[("pickaxe_item", "stone"), ("axe_item", "log"), ("hoe_item", "dirt"),
                      ...
                      ("dirt", "farmland"), ("water", "water_bucket_item"), ("edge_tool",
                                                                             "pickaxe_item"),
                      ("edge_tool", "axe_item"), ("tool", "hoe_item"), ("tool", "bucket_item"),
                      ("material", "stone"), ("material", "log"), ("material", "dirt"),
                      ("material", "water"), ("product", "log_item"), ("product",
                                                                       "cobblestone_item"),
                      ("product", "farmland"), ("product", "water_bucket_item")]]
            use_graph = True
            ...
            edges = [[("edge_tool", "pickaxe_item"), ("edge_tool", "axe_item"),
                      ...
                      ("material", "log"), ("material", "dirt"), ("material", "water"),
                      ("product", "log_item"), ("product", "cobblestone_item"),
                      ("product", "farmland"), ("product", "water_bucket_item"), ("product",
                                                                                  "hoe_item")]]
            use_graph = True
            ...
            edges = [[
                ('substance', 'stone'), ('object', 'stone'), ('stone', 'stone'),
                ('material', 'stone'), ('artifact', 'stone'), ('bucket_item', 'bucket_item'),
                ('instrumentality', 'bucket_item'), ('abstraction', 'bucket_item'),
                ('object', 'bucket_item'), ('artifact', 'bucket_item'), ('hoe_item', 'hoe_item'),
                ('physical_entity', 'hoe_item'), ('tool', 'hoe_item'),
                ('instrumentality', 'hoe_item'), ('object', 'hoe_item'), ('artifact', 'hoe_item'),
                ('physical_entity', 'pickaxe_item'), ('tool', 'pickaxe_item'), ('pickaxe_item',
                                                                                'pickaxe_item'),
                ('instrumentality', 'pickaxe_item'), ('edge_tool', 'pickaxe_item'),
                ('object', 'pickaxe_item'), ('artifact', 'pickaxe_item'), ('physical_entity',
                                                                           'axe_item'),
                ('axe_item', 'axe_item'), ('tool', 'axe_item'), ('instrumentality', 'axe_item'),
                ('edge_tool', 'axe_item'), ('object', 'axe_item'), ('artifact', 'axe_item'),
                ('water_bucket_item', 'water_bucket_item'), ('physical_entity',
                                                             'log'), ('log', 'log'), ('substance',
                                                                                      'log'),
                ('instrumentality', 'log'), ('material', 'log'), ('artifact', 'log'), ('farmland',
                                                                                       'farmland'),
                ('physical_entity', 'farmland'), ('object', 'farmland'), ('physical_entity',
                                                                          'water'), ('substance',
                                                                                     'water'),
                ('water', 'water'), ('body_waste', 'water'), ('artifact',
                                                              'water'), ('physical_entity', 'dirt'),
                ('dirt', 'dirt'), ('abstraction', 'dirt'), ('body_waste', 'dirt'), ('material',
                                                                                    'dirt'),
                ('cobblestone_item',
                 'cobblestone_item'), ('dirt_item', 'dirt_item'), ('log_item',
                                                                   'log_item'), ('farmland_item',
                                                                                 'farmland_item')
            ]]
...
#     use_graph = True
                ...
                "cnn", "embed_bl", 'embed_bl_converged_init', 'static_attribute',
                'dynamic_attribute'
        }:
            use_graph = False
            latent_nodes = []
    ...
    def forward(self, state):  #, extract_goal=True,extract_inv=True):
        ...
        if self.mode in graph_modes:
            ...
            # goal_embeddings = self.gcn.obj_emb(goals)
                ...
                "embed_bl", 'embed_bl_converged_init', 'static_attribute', 'dynamic_attribute'
        ]:
            pass
            #node_embeds = self.gcn.obj_emb(torch.arange(15).to(self.device))  #None
